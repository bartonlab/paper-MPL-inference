...
% run the AnalysisApproxWF_Comp.m script
...
disp('-------------------------------------------------------------------')
disp(' ')
disp(' This code will format the ground truth data for compatibility with ApproxWF. Chose datset to process:')
disp(' ')
...
%--------------------------------------------------------------------------
    ...
    warning off
%% 2. Get one point frequencies from the data
%--------------------------------------------------------------------------
    if(loadDataOption == 1)
